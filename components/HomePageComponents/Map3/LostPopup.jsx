...
export default function LostPopup(props) {
  ...
  return (
    <div className={`bg-neutral-800 rounded-3xl shadow-2xl border-2 border-transparent hover:bg-neutral-700 hover:border-red-100 transition-colors duration-500 ease-in-out p-0.5 text-slate-200 font-sans ${font1.className} flex flex-col`}>
