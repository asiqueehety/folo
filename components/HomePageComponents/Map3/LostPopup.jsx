...
export default function FoundPopup(props) {
  ...
  return (
    <div className={`bg-[#3e0000] bg-opacity-90 rounded-3xl shadow-2xl border-2 border-transparent hover:bg-[#3d2121] hover:border-red-100 transition-colors duration-500 ease-in-out p-0.5 text-slate-200 font-sans ${font1.className} flex flex-col`}>
