...
export default function MapContainerHome(props) {
  ...
  return (
    <div className={` lg:h-fit lg:w-fit w-full lg:rounded-2xl rounded-none flex lg:flex-row flex-col z-0 hover:scale-99 transition-all duration-500 justify-center items-center ${darkmode? 'bg-neutral-800' : 'bg-white'}`}>
      <MapContainer
        ...
        className="lg:rounded-4xl rounded-2xl md:w-180 sm:w-full w-75 lg:h-135 h-110 lg:shadow-stone-700 lg:shadow-lg shadow-none lg:m-2 m-0"
      >
        <TileLayer
