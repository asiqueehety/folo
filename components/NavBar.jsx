...
{
  return `h-fit lg:w-full w-fit rounded-2xl bg-white text-blue-950 lg:text-xl text-xs max-w-50 p-1 m-2 mb-1 border-none hover:bg-gradient-to-br from-purple-200 via-blue-200 to-red-100 hover:transition-all hover:scale-98`
}
...
export default function NavBar() {
  ...
  return (
    <div className={`${font1.className} fixed z-50`}>
      <nav className='w-screen h-20 bg-cyan-900 grid xl:grid-cols-[7fr_4fr] lg:grid-cols-[3fr_2fr] grid-cols-[3fr_2fr] animated-gradient-bg-navbar'>
